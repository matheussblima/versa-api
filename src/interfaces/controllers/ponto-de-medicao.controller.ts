...
export class PontoDeMedicaoController {
  ...
  @Get('subunidade/:subUnidadeId')
  @ApiOperation({ summary: 'Buscar pontos de medição por subunidade' })
  @ApiParam({
    name: 'subUnidadeId',
  ...
  @ApiResponse({
    status: 200,
    description: 'Pontos de medição da subunidade retornados com sucesso',
    type: [PontoDeMedicaoResponseDto],
  })
  @ApiResponse({
    status: 404,
